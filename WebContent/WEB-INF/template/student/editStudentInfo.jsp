		...
		<div class="content">
			<div class="easyui-tabs1" style="width: 100%;">
				<div class="basic-info">
					...
					<div id="controlBox">
						<a href="javascript:void(0)" class="easyui-linkbutton c2"  plain="true" iconCls="icon-add" onclick="addForm()">添加</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c4" plain="true" iconCls="icon-edit" >编辑</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c5" plain="true" iconCls="icon-cancel" onclick="destroy()">删除</a>
					...
					<table id="id_detailTable" class="kv-table">
						<tbody class="family-table" >
							<tr id="family" class="family-modle">
								<td class="kv-label" style="text-align:center;font-weight:bold">成员姓名</td>
								<td class="kv-label" style="text-align:center;font-weight:bold">与学生的关系</td>
								<td class="kv-label" style="text-align:center;font-weight:bold">成员工作</td>
							</tr>
							<c:forEach items="${member}" var="c" varStatus="st">
								<tr>
									<td class="kv-content" style="text-align:center;font-size:14px;">${c.membersName}</td>
									<td class="kv-content" style="text-align:center;font-size:14px;">${c.membersRelationship}</td>
									<td class="kv-content" style="text-align:center;font-size:14px;">${c.membersJob}</td>
								</tr>
							</c:forEach>
