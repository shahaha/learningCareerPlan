...
<body style="background:#FFFAE8;">
	...
	<div style="width: 75%; margin: 0 auto; padding-top: 3%;">
		...
		<div>
			<a style="float: right;margin-top:10px;" id="smallTarget" onclick="smallTarget()" class="easyui-linkbutton c4" iconCls="icon-ok">提交</a>
		</div>
		<br> <br>
		<br>
		<div class="column">
		...
		<div>
			<a style="float: right; margin-top:10px;" id="targetFeedBack" onclick="targetFeedBack()" class="easyui-linkbutton c4" iconCls="icon-ok">提交</a>
		</div>
	<br>
	</div>
	<script>
