...
<head> 
   ...
   if(sex==true){
	   $("#img").attr("src","<%=basePath%>images/man.png");
   }else{
	   $("#img").attr("src","<%=basePath%>images/woman.png");
   }
   }
...
<body onload="show()">
        ...
        <div id="pf-hd">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img src="<%=basePath%>images/man.png" style="width:30px;margin-left:10px;height:30px;" alt="me" id="img">
                </div>
	...
	function addTab(title, url, parameter){
		if ($('#menuTabs').tabs('exists', title)){        //判断当前选项卡是否存在
			$('#menuTabs').tabs('select', title);         //存在则显示
		} else {                                          //不存在则新建一个
