    ...
    <div class="container">
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav">
                     <li class="current">
                        <a onclick="addTab('学生信息录入','<%=basePath%>student/basic_info/${curUser.account}')">
            ...
            <div id="pf-page">
                <div id="menuTabs" class="easyui-tabs" style="width:100%;height:100%;">
                  <div title="首页" style="padding:10px 5px 5px 10px;">
                    <iframe class="page-iframe" src="<%=basePath%>student/workbench" frameborder="no"   border="no" height="100%" width="100%" scrolling="auto"></iframe>
                  </div>
                </div>
