...
<body>
			...
			<div  class="search" >选择要查看的年级: 第<span style="margin:0px 5px 0px 5px">
			<input id="curGrade" class="easyui-combobox" name="curGrade" 
											data-options="
											width:100,
											editable:false,
											required:true,
											url:'<%=basePath%>/manage/findAllGradeDate',
		                                    valueField:'id',
		                                    textField:'name',
		                                    panelHeight:'auto',
		                                    panelMaxHeight:200,
		                                    value: '2016',
		                                    onSelect: changeGrade" /></span>年级</div>
...
<script  type="text/javascript">
	...
	$(document).ready(function () {
		...
		request("POST",basePath+"manage/findEmploymentByGrade",requestParam,showChart,serverError,true);
	});
	function changeGrade(rec){
		//console.log(rec);
		var requestParam = {
				"grade": rec.name
			};
