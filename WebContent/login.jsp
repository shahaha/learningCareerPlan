...
<link href="<%=basePath%>css/main_base.css" rel="stylesheet" type="text/css">
					...
					<div class="lg-box">
						...
						<form id="logonForm">
							...
							<div class="lg-password input-item clearfix"
								style="border-radius: 8px;">
								<i class="iconfont">&#xe634;</i> <input id="password" name="password"
	...
	<script type="text/javascript">
		...
		function loginSuccess(responseData) {
			if( responseData.code == 200 ) {
				//request("POST",basePath+"base/loginRole",{},"","",true);
				window.location.href = basePath+"base/loginRole";
			}
